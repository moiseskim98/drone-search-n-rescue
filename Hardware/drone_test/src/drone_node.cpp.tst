...
int set_servo(ros::NodeHandle & nh,bool state)//false:close true:open(release)
{
  // arming
  ...
  msg.request.param2=state?1500:1900;
...
//   {
//     double speed_x=current_point.x/250.0;
//     double speed_y=current_point.y/250.0;
